...
// -------------------- Fake Offer Data --------------------
const offersByDate: Record<string, { category: 'Rooms' | 'Foods'; data: OfferItem[] }[]> = {
  '2025-06-10': [
    {
      category: 'Rooms',
      data: [
    ...
    },
    {
      ...
      data: [
        ...
        },
        {
          ...
          rating: 4.6,
          reviews: 89,
          description: 'Seafood dinner combo at 20% off for June 10 only.',
        },
      ],
    },
  ],
      ...
      data: [
        {
          ...
          rating: 4.95,
          reviews: 256,
          description: 'Relax in our premium executive suites at a discounted rate.',
        },
      ],
    },
  ],
...
export default function OffersPage() {
  ...
  const monthYearLabel = new Date(currentYear, currentMonth).toLocaleDateString('en-US', {
    month: 'long',
    year: 'numeric',
  });
  ...
  return (
    <div className="bg-[#f0f8ff] min-h-screen py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-3xl font-bold mb-4 text-gray-800">Offers & Packages</h1>
        <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
          Choose a date to explore room discounts and food offers available at Hotel Amin International.
        </p>
        ...
        {selectedDate && (
          <div className="text-left space-y-10">
            ...
            {Rooms.length > 0 && (
              <div>
                <h2 className="text-2xl font-bold mb-4">Room Offers</h2>
                  ...
                  {Rooms.map((offer, idx) => (
                    <SwiperSlide key={idx}>
                      <div className="bg-white rounded-lg shadow p-4">
                        ...
                        />
                        <h3 className="font-bold text-lg text-[#0B3C5D]">{offer.title}</h3>
                        <p className="text-sm text-gray-600">{offer.description}</p>
                        <p className="text-sm mt-2 text-gray-500">⭐ {offer.rating} ({offer.reviews} reviews)</p>
                      </div>
                    </SwiperSlide>
                  ))}
                </Swiper>
            ...
            {Foods.length > 0 && (
              <div>
                <h2 className="text-2xl font-bold mb-4">Food Offers</h2>
                <Swiper spaceBetween={16} slidesPerView={1.2} breakpoints={{
                  768: { slidesPerView: 2.2 },
                  1024: { slidesPerView: 3.2 },
                }}>
            ...
            {Rooms.length === 0 && Foods.length === 0 && (
              <p className="text-center text-gray-500 mt-10">No offers available for this date.</p>
            )}
          </div>
        )}
      </div>
