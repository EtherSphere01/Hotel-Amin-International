        ...
        details: [
            {
                ...
                description:
                    "Just steps away from Hotel Amin International, this beach offers a beautiful stretch of golden sand.",
            },
            {
                title: "Marine Drive",
                image: "https://www.solimarinternational.com/wp-content/uploads/sea-3243357_1280-1.jpg",
                description:
                    "Scenic coastal road with stunning ocean views. Great for peaceful drives or walks.",
            },
            {
                title: "Himchari",
                image: "https://www.solimarinternational.com/wp-content/uploads/sea-3243357_1280-1.jpg",
                description:
                    "Lush green hills, waterfalls, and sea view. Ideal for nature lovers and photographers.",
            },
        ],
    },
];
...
export default function GalleryPage() {
    ...
    const filteredData =
        selected === "All"
            ? galleryData
            : galleryData.filter((d) => d.category === selected);
                    ...
                    {section.images && (
                        <div className="relative">
                            ...
                            <button
                                ...
                                onClick={() =>
                                    swiperRefs.current[i]?.slidePrev()
                                }
                            >
                            ...
                            <button
                                ...
                                onClick={() =>
                                    swiperRefs.current[i]?.slideNext()
                                }
                            >
                                    ...
                                    {idx % 2 === 0 ? (
                                        <>
                                            ...
                                            <div className="border-l-4 pl-4 border-[#0B3C5D]">
                                                <h3 className="uppercase font-bold text-[#0B3C5D] text-lg">
                                                    {item.title}
                                                </h3>
                                        ...
                                        <>
                                            <div className="border-r-4 pr-4 border-[#FF9900] text-right self-end">
                                                <h3 className="uppercase font-bold text-[#FF9900] text-lg">
                                                    {item.title}
                                                </h3>
                                                <p className="text-gray-800 mt-2 text-justify">
                                                    {item.description}
