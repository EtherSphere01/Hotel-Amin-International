        ...
        {accommodations.map((room, index) => (
          <SwiperSlide key={index}>
            <div
              ...
              className={`transition-all duration-300 w-full flex justify-center cursor-pointer ${activeIndex === index ? "scale-105 z-10" : "scale-95 opacity-60"
                }`}
            >
                  ...
                  {activeIndex === index && (
                    <>
                      ...
                      <div className="flex gap-2 justify-center">
                        <button className="btn btn-warning btn-sm w-28">BOOK NOW</button>
                        <button className="btn btn-outline btn-sm w-28">DETAILS</button>
                      </div>
                    </>
                  )}
                </div>
